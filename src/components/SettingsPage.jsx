      ...
      <div className="bg-white rounded-2xl shadow-sm p-6">
        ...
        <div className="flex items-start justify-between mb-6">
          ...
          <div className="flex flex-col items-center gap-2 text-center">
            ...
            <div className="relative">
              ...
              {/* fallback */}
              <div
                className="w-20 h-20 rounded-full bg-gray-200 items-center justify-center text-3xl hidden"
                style={{ display: "none" }}
              >
                👤
              </div>
              {/* edit badge */}
              <button className="absolute bottom-0 left-0 w-6 h-6 bg-[#c9a84c] rounded-full flex items-center justify-center shadow">
            ...
            <div>
              <h2 className="text-lg font-bold text-gray-800">احمد علي</h2>
              <span className="border border-[#c9a84c] text-[#c9a84c] text-xs px-3 py-0.5 rounded-full">
                خدمة عملاء
              </span>
            </div>
          </div>
        ...
        <div className="mb-2">
          ...
          <div className="w-full h-3 bg-gray-100 rounded-full overflow-hidden">
            <div
              className="h-full rounded-full bg-gradient-to-l from-[#9C6402] to-[#E6C76A] transition-all duration-500"
